...
//adapted from https://github.com/microsoft/referencesource/blob/master/mscorlib/system/text/stringbuildercache.cs
...
namespace FolderSyncNetSource
{
    internal static class StringBuilderCache
    {
        ...
        internal const int StringBuilder_DefaultCapacity = 16;  //roland
        ...
        public static StringBuilder Acquire(int capacity = StringBuilder_DefaultCapacity)
        {
